...
public class UTServer extends JFrame {
...
//                    break;
            ...
            Logger.getLogger(UTServer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
